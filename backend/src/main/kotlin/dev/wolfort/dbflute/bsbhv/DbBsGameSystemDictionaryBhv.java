...
/**
 * The behavior of GAME_SYSTEM_DICTIONARY as TABLE.
...
public abstract class DbBsGameSystemDictionaryBhv extends AbstractBehaviorWritable<DbGameSystemDictionary, DbGameSystemDictionaryCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">gameSystemDictionaryBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of DbGameSystemDictionary. (NotNull)
