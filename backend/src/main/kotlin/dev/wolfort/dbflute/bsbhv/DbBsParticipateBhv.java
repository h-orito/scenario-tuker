...
/**
 * The behavior of PARTICIPATE as TABLE.
...
public abstract class DbBsParticipateBhv extends AbstractBehaviorWritable<DbParticipate, DbParticipateCB> {
     ...
     */
    public List<DbGameSystem> pulloutGameSystem(List<DbParticipate> participateList)
    { return helpPulloutInternally(participateList, "gameSystem"); }
     ...
     * <pre>
     * <span style="color: #0000C0">participateBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of DbParticipate. (NotNull)
