...
/**
 * The behavior of USER_RULE_BOOK as TABLE.
...
public abstract class DbBsUserRuleBookBhv extends AbstractBehaviorWritable<DbUserRuleBook, DbUserRuleBookCB> {
     ...
     * <pre>
     * <span style="color: #0000C0">userRuleBookBhv</span>.<span style="color: #CC4747">queryDelete</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of DbUserRuleBook. (NotNull)
